<%-- 
    Document   : usersingup
    Created on : 29-May-2020, 06:04:34
    Author     : RIFAT
--%>
                ...
                <div class="card-body">
                    ...
                    <form action="UserRegister" method="post" >
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="exampleInputEmail1" name="fname" placeholder="Enter Your First Name">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" id="exampleInputEmail1" name="lname" placeholder="Enter Your Last Name">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="exampleInputEmail1" name="phone" placeholder="Enter Your Phone No">
                        </div>
