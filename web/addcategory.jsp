<%-- 
    ...
    Created on : 30-May-2020, 07:50:10
    Author     : RIFAT
--%>
                ...
                <div class="card-body">
                    ...
                    <form action="CreateCategory" method="post" >
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="exampleInputEmail1" name="name" placeholder="Enter Cetagory Name">
                        </div>
                        <div class="form-group">                            
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="details" placeholder="Write Category Details here"></textarea>
                        </div>
